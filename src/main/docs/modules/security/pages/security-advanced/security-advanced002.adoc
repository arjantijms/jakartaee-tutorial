...
See <<_overview_of_the_http_authentication_mechanism_interface>>.
...
image::images:jakartaeett_dt_048.svg["Diagram of six steps in mutual authentication with certificates"]
...
image::images:jakartaeett_dt_049.svg["Diagram of five steps in mutual authentication with user name and password"]
