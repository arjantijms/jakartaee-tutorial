...
As discussed in <<_distributed_multitiered_applications>>, the Jakarta EE platform uses a distributed multitiered application model, and web applications run in the web tier.
...
See <<_overview_of_jakarta_security>> for more information.
+
